...
function PlaceCreate() {
  ...
  const fetchCategories = async () => {
    ...
    await Api.get("/web/categories").then((response) => {
  ...
  const storePlace = async (e) => {
    ...
    //send data to server
    await Api.post("/admin/place", formData, {
      //header
      headers: {
        //header Bearer + Token
                ...
                <form onSubmit={storePlace}>
                  <div className="mb-3">
                    <label className="form-label fw-bold">
                      Image (<i>pilih lebih banyak file</i>)
                    </label>
                    <input
                      type="file"
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <div className="mb-3">
                        <label className="form-label fw-bold">Web</label>
                        <input
                          type="text"
                          className="form-control"
